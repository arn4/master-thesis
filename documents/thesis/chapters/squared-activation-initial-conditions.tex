...
% spiegare che spesso dobbiamo mediare per avere qualcosa di sensato.
% Devo assolutamente dire anche che spesso guardo |m| e non m perché c'é la simmetria.
% Devo dire che gamma é piccolo; a tal proposito compariranno tante disuguaglianze nelle varie ODE
...
The natural thing to do now is to replace these combined initial conditions with Equations~\eqref{eq:phase_retrivial},
...
\end{figure}
\FloatBarrier %todo: vuoi davvero questa barriera?
...
\begin{figure}
  \centering
  \begin{tikzpicture}  
    \input{figures/pictorial-unconstrained-phase-retrivial.tikz}
  \end{tikzpicture}
  \caption{
...
Figure~\ref{fig:sigma-phase-retrivial-exittimes} shows a comparison between what is predicted by the formulas
